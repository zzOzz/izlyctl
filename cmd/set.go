...
// setCmd represents the cards command
...
to quickly create a Cobra application.`,
	Run: func(cmd *cobra.Command, args []string) {
		...
		logrus.Debugf("rate: %d", viper.GetInt("user.rate"))
		client := crous.New()
		client.Authenticate()
		card:=client.ChangeRightHolderRate(args[0], viper.GetInt("user.rate"), viper.GetString("user.dueDate"))
