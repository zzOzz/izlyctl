// Copyright © 2018 Vincent Lombard <vincent.lombard@gmail.com>
//
...
var rootCmd = &cobra.Command{
	Use:   "izlyctl",
	Short: "Command line utility for Izly Cards",
	Long: `This command line tool is used to get registred Izly cards from CROUS API.`,
...
func init() {
	...
	rootCmd.PersistentFlags().StringVar(&cfgFile, "config", "", "config file (default is $HOME/.izlyctl.yaml)")
	rootCmd.PersistentFlags().StringP("user","u", "", "Crous API USER Login")
